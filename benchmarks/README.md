...
+------------------------+--------+----------+---------+------------+------------+--------+--------+--------+
| Parser                 |   Runs | Wall (s) | CPU (s) |      RSS Δ |    Py Peak | µs/run |  rec/s | Status |
+------------------------+--------+----------+---------+------------+------------+--------+--------+--------+
| Rust parse_tuple       | 10,000 |   0.1498 |  0.1496 |  0.109 MiB |  0.003 MiB |   15.0 | 66,775 | ok     |
| Rust parse (dict)      | 10,000 |   0.2166 |  0.2164 |  0.031 MiB |  0.003 MiB |   21.7 | 46,163 | ok     |
| Rust parse_many(10000) | 10,000 |   0.2725 |  0.2724 | 29.484 MiB | 32.717 MiB |   27.2 | 36,704 | ok     |
| Py SW→Regex            | 10,000 |   3.2993 |  3.2965 |  0.312 MiB |  0.009 MiB |  329.9 |  3,031 | ok     |
| Py Regex-only          | 10,000 |   3.9363 |  3.9348 |  0.016 MiB |  0.008 MiB |  393.6 |  2,540 | ok     |
+------------------------+--------+----------+---------+------------+------------+--------+--------+--------+
...
| Parser             | Runs | Wall (s) | CPU (s) |     RSS Δ |   Py Peak |   µs/run |  rec/s | Status |
+--------------------+------+----------+---------+-----------+-----------+----------+--------+--------+
| Structly parse     |  100 |   0.0023 |  0.0023 | 0.000 MiB | 0.003 MiB |     22.6 | 44,217 | ok     |
| whois-parser parse |  100 |  12.1417 | 12.1390 | 1.438 MiB | 0.336 MiB | 121416.7 |      8 | ok     |
+--------------------+------+----------+---------+-----------+-----------+----------+--------+--------+
```
